...
static const ScmlOpcodeInfo g_opcodes[] = {
    ...
    {0x0B15, SCML_OP_ARRAY_PUSH, "ARRAY_PUSH", 2, 2},
    {0x0B16, SCML_OP_ARRAY_POP, "ARRAY_POP", 2, 2},
    {0x0B17, SCML_OP_ARRAY_LEN, "ARRAY_LEN", 2, 2},
    {0x0B18, SCML_OP_INT, "INT", 2, 2},
    {0x0B19, SCML_OP_INT2, "INT2", 2, 2},
    {0x0B1A, SCML_OP_INT4, "INT4", 2, 2},
    {0x0B1B, SCML_OP_INT8, "INT8", 2, 2},
    {0x0B1C, SCML_OP_INT16, "INT16", 2, 2},
    {0x0B1D, SCML_OP_INT32, "INT32", 2, 2},
    {0x0B1E, SCML_OP_INT64, "INT64", 2, 2},
    {0x0B1F, SCML_OP_TYPE_OF, "TYPE_OF", 2, 2},
    {0x0B20, SCML_OP_BOOL, "BOOL", 2, 2},
    {0x0B21, SCML_OP_NULL, "NULL_VALUE", 1, 1},
    {0x0B22, SCML_OP_CLASS_DEFINE, "CLASS_DEFINE", 2, 2},
    {0x0B23, SCML_OP_CLASS_EXTENDS, "CLASS_EXTENDS", 2, 2},
    {0x0B24, SCML_OP_OBJECT_NEW, "OBJECT_NEW", 2, 2},
    {0x0B25, SCML_OP_FIELD_SET, "FIELD_SET", 3, 3},
    {0x0B26, SCML_OP_FIELD_GET, "FIELD_GET", 3, 3},
    {0x0B27, SCML_OP_INSTANCE_OF, "INSTANCE_OF", 3, 3},
    {0x0B28, SCML_OP_CLASS_METHOD, "CLASS_METHOD", 3, 3},
    {0x0B29, SCML_OP_METHOD_CALL, "METHOD_CALL", 2, 8},
    {0x0B2A, SCML_OP_IS_TYPE, "IS_TYPE", 3, 3},
    {0x0B2B, SCML_OP_FLOAT32, "FLOAT32", 2, 2},
    {0x0B2C, SCML_OP_STRING_CAST, "STRING", 2, 2},
